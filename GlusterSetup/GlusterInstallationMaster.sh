...
ssh $client_user1@$client_ip "mkdir /home/$client_user1/RaaSI"

echo "Transfering GlusterInstallationNode.sh script to Storage1..."
scp GlusterInstallationNode.sh $client_user1@$client_ip:/home/$client_user1/RaaSI/GlusterInstallationNode.sh

echo "Making GlusterInstallationNode.sh executable..."
ssh -t $client_user1@$client_ip "sudo chmod +x /home/$client_user1/RaaSI/GlusterInstallationNode.sh"

echo "Executin GlusterInstallationNode.sh on Storage1..."
ssh -t $client_user1@$client_ip "sudo /home/$client_user1/RaaSI/GlusterInstallationNode.sh"
...
ssh $client_user2@$client_ip "mkdir /home/$client_user2/RaaSI"

echo "Transfering GlusterInstallationNode.sh script to Storage2..."
scp GlusterInstallationNode.sh $client_user2@$client_ip:/home/$client_user2/RaaSI/GlusterInstallationNode.sh

echo "Making GlusterInstallationNode.sh executable..."
ssh -t $client_user2@$client_ip "sudo chmod +x /home/$client_user2/RaaSI/GlusterInstallationNode.sh"

echo "Executin GlusterInstallationNode.sh on Storage2..."
ssh -t $client_user2@$client_ip "sudo /home/$client_user2/RaaSI/GlusterInstallationNode.sh"
...
ssh $client_user3@$client_ip "mkdir /home/$client_user3/RaaSI"

echo "Transfering GlusterInstallationNode.sh script to Storage3..."
scp GlusterInstallationNode.sh $client_user3@$client_ip:/home/$client_user3/RaaSI/GlusterInstallationNo>

echo "Making GlusterInstallationNode.sh executable..."
ssh -t $client_user3@$client_ip "sudo chmod +x /home/$client_user3/RaaSI/GlusterInstallationNode.sh"

echo "Executin GlusterInstallationNode.sh on Storage3..."
ssh -t $client_user3@$client_ip "sudo /home/$client_user3/RaaSI/GlusterInstallationNode.sh"
